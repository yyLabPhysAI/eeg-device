...
def streaming_app():
    ...
    with placeholder.container():
        while True:
            ...
            ax[0,0].plot(data.iloc[-500:, 1])
            ax[0,0].set_title('EEG 1')
            ax[0,0].axis('off')
            ax[1,0].plot(data.iloc[-500:, 2])
            ax[1,0].set_title('\n EEG 2')
            ax[1,0].axis('off')
            ax[2,0].plot(data.iloc[-500:, 3])
            ax[2,0].axis('off')
            ax[2,0].set_title('\n EEG 3')
            ax[0, 1].plot(data.iloc[-500:, 4])
            ax[0, 1].axis('off')
            ax[0, 1].set_title('\n EEG 4')
            ax[1, 1].plot(data.iloc[-500:, 5])
            ax[1, 1].axis('off')
            ax[1, 1].set_title('\n EEG 5')
            plt.draw()
